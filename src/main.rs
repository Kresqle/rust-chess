...
const PROGRAM_DESC: &'static str = "Rust chess engine";
const PROGRAM_NAME: &'static str = "Chess AI";
...
) -> Result<(bool, bool, bool, String, i8), ArgsError>
{
    ...
    return Ok((is_interactive, is_self_play, run_benchmarks, fen_str, ply_count));
}
